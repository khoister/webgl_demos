...
Maze.prototype.initialize = function()
{
  ...
  var blue     = new THREE.MeshLambertMaterial({color: 0x2D4596, side: THREE.DoubleSide}); // BLUE
  var red      = new THREE.MeshLambertMaterial({color: 0xD62854, side: THREE.DoubleSide}); // RED
...
{
  var directions = [Maze.TOP, Maze.RIGHT, Maze.BOTTOM, Maze.LEFT];
